	...
	window.addEventListener('load', function () {
	 ...
	 /*********************** REDO FUNCTION*************************/
		...
		function frameDraw() {
			...
			frame1 = cnvs1.toDataURL("image/gif");

			if ((curFrame == 1) && (images.length == 0) && (images1.length == 0)){
				images.push(frame);
				images1.push(frame);
			}

			else if( curFrame == images.length && curFrame == images1.length){
				images[curFrame-1] = frame;
				images1[curFrame-1] = frame;
			}
